...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      card4_p: "Torrt är galtborst styvt (3–6 GPa), men när man blöter ner den mjuknar den till ≤1 GPa – mjukare än nylon, som ligger kvar på 2–3 GPa även blött. Mjuka strån just när de möter tänder och tandkött.",
    ...
    en: {
      ...
      card4_p: "Dry, boar bristle is stiff (3–6 GPa), but once you wet it down it softens to ≤1 GPa – softer than nylon, which stays at 2–3 GPa even when wet. Soft bristles right where they meet teeth and gums.",
