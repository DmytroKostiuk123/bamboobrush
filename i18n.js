...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      gws_instock: "I lager",
      gws_add: "Lägg i varukorg",
      gws_more: "Läs mer →",
      gws_tb6_title: "Bambutandborste 6-pack",
      gws_tb6_sub: "Bambuhandtag och strån av galtborst. Ingen plast.",
      ...
      feat_2: "🐗 Vildsvinsborst, inga plaststrån",
      ...
      pdp_d_desc_1: "BambooBrush 6-pack är sex tandborstar tillverkade helt av naturmaterial – för dig som vill ha en hållbar tandborste utan plast i munnen.",
      ...
      pdp_d_desc_3: "Helt utan plast, lim och BPA. Inga plaststrån, bara bambu och vildsvinsborst.",
      ...
      cart_discount: "🎁 Paketrabatt −{amount} kr",
      cart_freeship: "🚚 Fri frakt (DHL) ingår",
      pack_pick_label: "Välj antal förpackningar",
      pack_pop: "Populär",
      pack_best: "Bäst värde",
      pack1_sub: "6 borstar totalt",
      pack2_sub: "12 borstar totalt",
      pack3_sub: "18 borstar totalt",
      pack1_note: "+ 49 kr frakt",
      pack2_note: "Spara 40 kr · fri frakt",
      pack3_note: "Spara 100 kr · fri frakt",
    },
    ...
    en: {
      ...
      gws_instock: "In stock",
      gws_add: "Add to cart",
      gws_more: "Read more →",
      gws_tb6_title: "Bamboo toothbrush 6-pack",
      gws_tb6_sub: "Bamboo handle, boar-bristle tufts. No plastic.",
      ...
      feat_2: "🐗 Wild boar bristles, no plastic",
      ...
      pdp_d_desc_3: "Completely free from plastic, glue and BPA. No plastic bristles, just bamboo and wild boar bristle.",
      ...
      cart_discount: "🎁 Bundle discount −{amount} kr",
      cart_freeship: "🚚 Free shipping (DHL) included",
      pack_pick_label: "Choose how many packs",
      pack_pop: "Popular",
      pack_best: "Best value",
      pack1_sub: "6 brushes total",
      pack2_sub: "12 brushes total",
      pack3_sub: "18 brushes total",
      pack1_note: "+ 49 kr shipping",
      pack2_note: "Save 40 kr · free shipping",
      pack3_note: "Save 100 kr · free shipping",
    },
  };
