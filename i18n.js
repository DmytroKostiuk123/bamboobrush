...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      gw_p2: "Att göra handtaget i bambu är <strong>lätt</strong> – nästan alla gör det. Det svåra är <strong>stråna</strong>. På de flesta bambutandborstar är stråna av <strong>nylon</strong>. Alltså plast. Och en borste med plaststrån kan du <strong>aldrig</strong> kompostera, hur grön den än ser ut.",
    ...
    en: {
      ...
      gw_p2: "Making the handle from bamboo is <strong>easy</strong> – almost everyone does it. The hard part is the <strong>bristles</strong>. On most bamboo toothbrushes the bristles are made of <strong>nylon</strong>. That's plastic. And a brush with plastic bristles can <strong>never</strong> be composted, however green it looks.",
