...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      pdp_d_comp_1: 'När borsten är utsliten kan du kompostera hela den – både bambuhandtaget och galtborsten (keratin) bryts ner, så du behöver inte dra ut stråna. Vill du vara noggrann plockar du bort den lilla metallklammern och återvinner den som metall. Läs mer i vår guide <a href="../blogg/kompostera-tandborsten.html">Så komposterar du din bambutandborste</a>.',
    ...
    en: {
      ...
      pdp_d_comp_1: 'When the brush is worn out you can compost the whole thing – both the bamboo handle and the boar bristle (keratin) break down, so you don\'t need to pull out the bristles. If you want to be thorough, pick out the small metal staple and recycle it as metal. Read more in our guide <a href="../blogg/kompostera-tandborsten.html">How to compost your bamboo toothbrush</a>.',
      pdp_rev_h: "Reviews",
