...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      gw_p2: 'Ett bambuhandtag är den <strong>lätta</strong> delen – nästan alla klarar det. Det svåra är <strong>stråna</strong>. På de flesta "miljövänliga" bambutandborstar är stråna gjorda av <strong>nylon</strong>. Alltså plast. Och en tandborste med plaststrån kan du <strong>aldrig</strong> kompostera – hur grönt handtaget än marknadsförs.',
    ...
    en: {
      ...
      gw_p2: 'A bamboo handle is the <strong>easy</strong> part – almost everyone manages that. The hard part is the <strong>bristles</strong>. On most "eco-friendly" bamboo toothbrushes the bristles are made of <strong>nylon</strong>. That\'s plastic. And a toothbrush with plastic bristles can <strong>never</strong> be composted – however green the handle is marketed.',
