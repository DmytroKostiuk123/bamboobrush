...
(function () {
  ...
  var DICT = {
    sv: {
      ...
      prod_desc: "Sex tandborstar i naturlig bambu med mjuka, BPA-fria borst. Ett års förbrukning för en person – eller perfekt att dela med familjen. Levereras i komposterbar förpackning.",
      ...
      pdp_d_desc_2: "Handtaget är av naturlig bambu, ett snabbväxande gräs som är komposterbart. Borsten är naturborst (galtborst av keratin) med medium hårdhet – samma protein som finns i hår och naglar, helt fritt från nylon och mikroplast. Borsten fästs i handtaget med en liten metallklammer, som du enkelt plockar bort innan du komposterar handtaget.",
      pdp_d_desc_3: "Helt utan plast, lim och BPA. Levereras i en komposterbar pappersförpackning.",
      ...
      pdp_d_spec_5: "<strong>Förpackning:</strong> komposterbar papp",
      pdp_d_comp_h: "Kompostering & återvinning",
      pdp_d_comp_1: 'När borsten är utsliten: dra eller klipp bort borsttofsarna och metallklammern (metallen återvinns) och kompostera bambuhandtaget – det blir till jord på ungefär sex månader. Läs mer i vår guide <a href="../blogg/kompostera-tandborsten.html">Så komposterar du din bambutandborste</a>.',
    ...
    en: {
      ...
      prod_desc: "Six toothbrushes in natural bamboo with soft, BPA-free bristles. A year's supply for one person – or perfect to share with the family. Delivered in compostable packaging.",
      ...
      pdp_d_spec_5: "<strong>Packaging:</strong> compostable cardboard",
      pdp_d_comp_h: "Composting & recycling",
      pdp_d_comp_1: 'When the brush is worn out: pull or cut off the bristle tufts and the metal staple (the metal is recycled) and compost the bamboo handle – it turns to soil in about six months. Read more in our guide <a href="../blogg/kompostera-tandborsten.html">How to compost your bamboo toothbrush</a>.',
      pdp_rev_h: "Reviews",
